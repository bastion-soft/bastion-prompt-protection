...
Run order (e.g. as the last Colab cell):
    ...
    python -m scripts.eval_indirect           --dump-scores eval/results/scores_indirect
...
from eval.benchmark_suite import SuiteRow
from eval.metrics import binary_metrics
from eval.scores_io import load_all_scores, slugify
...
def _parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--scores-indirect-dir", default="eval/results/scores_indirect")
    return p.parse_args()
